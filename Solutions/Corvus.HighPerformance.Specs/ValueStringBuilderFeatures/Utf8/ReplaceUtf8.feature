...
Scenario Outline: No change
	Given a UTF-8 ValueStringBuilder initialized with '<InitializationType>' of length 13
...
Scenario Outline: Shrinks
	Given a UTF-8 ValueStringBuilder initialized with '<InitializationType>' of length 23
	And I append 'Hello, World or wherever!' to the UTF-8 ValueStringBuilder
	And I replace '<Find>' with '<Replacement>' at index <Start> with count <Length> in the UTF-8 ValueStringBuilder
	When I get the string from the UTF-8 ValueStringBuilder
	Then the UTF-8 ValueStringBuilder string should be '<Result>'
	Examples:
...
Scenario Outline: Grows and requires resize
	Given a UTF-8 ValueStringBuilder initialized with '<InitializationType>' of length 32
...
Scenario Outline: Specified range is out of bounds
	Given a UTF-8 ValueStringBuilder initialized with '<InitializationType>' of length 25
	And I append 'Hello, World or wherever!' to the UTF-8 ValueStringBuilder
	And I attempt to replace '<Find>' with '<Replacement>' at index <Start> with count <Length> in the UTF-8 ValueStringBuilder
